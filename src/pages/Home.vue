        ...
        <div class="container bg-container">
            ...
            <div class="row gap-4 text-white justify-content-center space-category-top space-category-bottom">
              ...
              <div>{{ category.name }}</div> -->
                ...
                <button class="text-orange font-cat bg-transparent" type="button" @click="getAllRestaurants()">tutti i
                    ristoranti</button>
            </div>
            ...
            <div class="col" v-for="restaurant in filteredRestaurants" :key="restaurant.id">
                <div class="card bg-orange h-100 w-100" style="width: 18rem">
                    <img v-if="restaurant.cover_img" class="card-img-top"
                        src="http://127.0.0.1:8000/ + '/storage/' + restaurant.cover_img)" alt="Card image cap" />
                    <div class="card-body">
